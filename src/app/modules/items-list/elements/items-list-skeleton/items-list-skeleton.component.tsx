  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap gap-2">
        <div className="h-10 w-full max-w-sm animate-pulse rounded-md bg-slate-200 dark:bg-slate-800" />
        <div className="h-10 w-44 animate-pulse rounded-md bg-slate-200 dark:bg-slate-800" />
