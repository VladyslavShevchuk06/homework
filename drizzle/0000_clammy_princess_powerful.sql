...
CREATE UNIQUE INDEX "user_item_unique" ON "favorites" USING btree ("user_id","item_id");--> statement-breakpoint
CREATE INDEX "favorites_user_id_idx" ON "favorites" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "favorites_item_id_idx" ON "favorites" USING btree ("item_id");--> statement-breakpoint
