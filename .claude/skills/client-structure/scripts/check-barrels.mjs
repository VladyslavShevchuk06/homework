...
// CLI
// platform-safe main-module check: on Windows process.argv[1] is a drive path (D:…),
// which never equals the file:// URL form, so a naive comparison silently skips the CLI
